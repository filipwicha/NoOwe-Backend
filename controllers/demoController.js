...
exports.data = (req, res) => {
    var json = {
        "main": {
            "temp": getRandomArbitrary(19, 22),
            "pressure": getRandomInt(1001, 1004),
            "humidity": getRandomArbitrary(54, 58)
        },
        "wind": {
            "speed": getRandomArbitrary(5, 7),
            "gust": getRandomArbitrary(5, 7),
            "deg": getRandomInt(140, 190)
        },
        "dt": new Date().valueOf()
    }
